...
public interface IJwtAuthManager
{
    ...
    Task<RefreshTokenResult> Refresh(string refreshToken, string accessToken, string claimName, DateTime utcNow, string additionalInfo = null);
    Task<string> GetAdditionalInfo(string refreshToken);
